public class Money implements Comparable<Money> {
  ...
  public void add(Money other) {
    ...
    if(this.getCents() > 100){
        this.dollars = this.getDollars() + (this.getCents()/100);
        this.cents = (this.getCents()%100);
    }
    this.dollars += other.dollars + other.cents / 100;
  ...
  public int compareTo(Money other) {
     ...
     */
    if (this.dollars - other.getDollars() == 0) if (
      this.cents - other.getCents() == 0
    ) return 0; else if (
      this.cents - other.getCents() > 0
    ) return 1; else return -1; else if (
      this.dollars - other.getDollars() > 0
  ...
  public boolean equals(Object other) {
    ...
    if (other != null && this.getClass().equals(other.getClass())) {
      ...
      if (this.compareTo((Money) other) == 0) {
        //System.out.println("These two instances have the same values!");
        return true;
      } else return false;
    }
    return false;
